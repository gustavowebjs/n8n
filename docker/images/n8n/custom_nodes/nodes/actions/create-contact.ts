...
async function createContact(
  ...
  const email = context.getNodeParameter("email", itemIndex, "") as string; // Optional with default
  const phone = context.getNodeParameter("phone", itemIndex, "") as string; // Optional with default
